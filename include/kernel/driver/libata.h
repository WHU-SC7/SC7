...
[[maybe_unused]]static bool ata_id_is_ata(const uint16_t *id)
{
...
[[maybe_unused]]static bool ata_id_has_dma(const uint16_t *id)
{
    return (id[ATA_ID_CAPABILITY] & (1 << 8)) != 0;
}
[[maybe_unused]]static bool ata_id_has_ncq(const uint16_t *id)
{
...
[[maybe_unused]]static bool ata_id_removable(const uint16_t *id)
{
...
[[maybe_unused]]static bool ata_id_hpa_enabled(const uint16_t *id)
{
