...
static longtest ltp[] = {
    ...
    // {1, {"/glibc/ltp/testcases/bin/link05", 0}},     ///< @todo sigkill卡住
    ...
    // {1, {"/glibc/ltp/testcases/bin/pipe2_04", 0}}, //卡主
    ...
    // {1, {"/glibc/ltp/testcases/bin/readdir01", 0}},      ///< @todo inode=0
    ...
    {1, {
            "/glibc/ltp/testcases/bin/select04", 0}},
