...
extern int sys_mount(const char *special, const char *dir, const char *fstype, unsigned long flags, const void *data) __attribute__((section(".text.syscall_function"))); 
#endif
