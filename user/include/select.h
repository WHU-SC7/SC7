 ...
 * @return 返回就绪的文件描述符数量，超时返回0，错误返回-1
 */
int pselect6_time32(int nfds, fd_set *readfds, fd_set *writefds,
                   fd_set *exceptfds, struct old_timespec32 *timeout, void *sigmask);
